...
sns.barplot(x=u'Region', y='perPrice', palette="Blues_d", data=df_house_mean, ax=ax1)
ax1.set_title('unit price in sc ',fontsize=15)
ax1.set_xlabel(u'region')
ax1.set_ylabel('unit price')

sns.barplot(x=u'Region', y='price', palette="Greens_d", data=df_house_count, ax=ax2)
ax2.set_title('region comparation',fontsize=15)
ax2.set_xlabel(u'region')
ax2.set_ylabel('quantity')

sns.boxplot(x=u'Region', y='price', data=zf, ax=ax3)
ax3.set_title('total price in sz',fontsize=15)
ax3.set_xlabel(u'region')
