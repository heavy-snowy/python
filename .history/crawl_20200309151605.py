...
def parse_pages(pages):
    ...
    for house in all_house:
        ...
        # print(title)
        href=house.find('a', class_='strongbox').get('href')
        # print(href)
        # 价格
        price = house.find('div', class_='money').find('b',class_='strongbox').text.strip()
        # print(price)
...
#         print(agent)
#    data[title,price,layout,address,agent,href]
            csv_writer.writerow([title,price,layout,address,agent,href])
#    save_to_mysql(data)
#    csv_writer.writerow([title,price,layout,address,agent]）
#        save_to_mysql(data)
    num += 1
...
#    print('MySQL表58tc_data创建成功！')
    ...
    for i in range(0,1):
        url = 'https://sz.58.com/chuzu/pn5/?PGTID=0d3090a7-0000-4251-d188-4b7bb956f6c0&ClickID=2'
