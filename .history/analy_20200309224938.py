...
# # 房间大小和租金的关系
# sns.regplot(x='size', y='price', data=zf, ax=ax2)
# plt.show()


# f, ax1= plt.subplots(figsize=(20,20))
# sns.countplot(y='layouts', data=zf, ax=ax1)
...
# zf['form'] = zf.loc[(zf['form'] == '有电梯')|(zf['form'] == '无电梯'), 'form']
...
sns.countplot(zf['form'], ax=ax1)
ax1.set_title('是否整租对比',fontsize=15)
ax1.set_xlabel('是否整租')
ax1.set_ylabel('数量')

sns.barplot(x='form', y='perPrice', data=zf, ax=ax2)
ax2.set_title('是否整租对比',fontsize=15)
ax2.set_xlabel('是否整租')
ax2.set_ylabel('每平米租金')

sns.barplot(x='form', y='price', data=zf, ax=ax3)
ax3.set_title('是否整租对比',fontsize=15)
ax3.set_xlabel('是否整租')
ax3.set_ylabel('月租金')
plt.show()